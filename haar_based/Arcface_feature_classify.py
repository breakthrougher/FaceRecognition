...
# X_embedded = TSNE(n_components=2).fit_transform(X_train.cpu().numpy())

# plt.figure(figsize=(10, 10))

# for i in range(120):
#     plt.scatter(X_embedded[y_train.cpu() == i, 0], X_embedded[y_train.cpu() == i, 1], label=str(i))
